        ...
        <header class="masthead">
            <div class="container">
                ...
                <div class="masthead-heading text-uppercase">
                    We are ready for negotiation</div>
            ...
            <div class="container">
                ...
                <div class="row text-center">
                    <div class="col-md-4">
                        ...
                        <p class="text-muted">Etendre sa zone de chalandise, de profiter d'un marché en plein essor et de générer plus de ventes entre chaque Client </p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <div class="col-md-4">
                        ...
                        <h4 class="my-3">Shopping</h4>
                        <p class="text-muted">Découvrir des produits ou des services directement en ligne 24h/24 et 7j/7, mais aussi réaliser des achats à n'importe quel moment du jour ou de la nuit.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted"> Qui convient a tous vos besoins.</h3>
                </div>
                <div class="row">
                    <div class="col-lg-6 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">Livres</div>
                    ...
                    <div class="col-lg-6 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">Vêtements</div>
                                <div class="portfolio-caption-subheading text-muted">Tee-Shirt</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-sm-6 mb-4 mb-lg-0">
                        ...
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">DVD</div>
                    ...
                    <div class="col-lg-6 col-sm-6 mb-4 mb-sm-0">
                        ...
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">Meubles</div>
